...
void gpio_export ( unsigned int gpio )  {
  ...
  uav_err( len <=0, "Error (gpio_export): Failed to assign path. ");

  fd = open( GPIO_PATH "/export", O_WRONLY );
  uav_err( fd <0, "Error (gpio_export): Failed to open file. ");
...
void gpio_unexport ( unsigned int gpio )  {
  ...
  len = snprintf( buf, sizeof(buf), "%d", gpio );
  uav_err( len <=0, "Error (gpio_unexport): Failed to assign path. ");

  fd = open( GPIO_PATH "/unexport", O_WRONLY );
  uav_err( fd <0, "Error (gpio_unexport): Failed to open file. ");
...
void gpio_set_dir ( unsigned int gpio, enum PIN_DIR dir )  {
  ...
  uav_err( len <=0, "Error (gpio_set_dir): Failed to assign path. ");

  fd = open( buf, O_WRONLY );
  uav_err( fd <0, "Error (gpio_set_dir): Failed to open file. ");
...
void gpio_set_val ( unsigned int gpio, enum PIN_VAL val )  {
  ...
  uav_err( len <=0, "Error (gpio_set_val): Failed to assign path. ");

  fd = open( buf, O_WRONLY );
  uav_err( fd <0, "Error (gpio_set_val): Failed to open file. ");
...
void gpio_get_val ( unsigned int gpio, unsigned int *val )  {
  ...
  len = snprintf( buf, sizeof(buf), GPIO_PATH "/gpio%d/value", gpio );
  uav_err( len <=0, "Error (gpio_get_val): Failed to assign path. ");

  fd = open( buf, O_RDONLY );
  uav_err( fd <0, "Error (gpio_get_val): Failed to open file. ");
...
void gpio_set_edge ( unsigned int gpio, char *edge ) {
  ...
  uav_err( len <=0, "Error (gpio_set_edge): Failed to assign path. ");

  fd = open( buf, O_WRONLY );
  uav_err( fd <0, "Error (gpio_set_edge): Failed to open file. ");
...
void gpio_fd_open ( unsigned int gpio )  {
  ...
  len = snprintf( buf, sizeof(buf), GPIO_PATH "/gpio%d/value", gpio );
  uav_err( len <=0, "Error (gpio_fd_open): Failed to assign path. ");

  fd = open( buf, O_RDONLY | O_NONBLOCK );
  uav_err( fd <0, "Error (gpio_fd_open): Failed to open file. ");
